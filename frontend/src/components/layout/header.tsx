  ...
  const notifications = [
    {
      ...
      description: "John Smith requested access",
      time: "5 min ago",
      unread: true,
    },
    {
      ...
      description: "Team Meeting has been approved",
      time: "1 hour ago",
      unread:  true,
    },
    {
    ...
    <header className="sticky top-0 z-40 border-b border-white/5 bg-[#050505]/80 backdrop-blur-xl">
      <div className="flex items-center justify-between px-4 md:px-8 py-4">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Mobile Title */}
          <span className="md:hidden text-zinc-200 font-medium text-sm">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <div className="hidden lg:flex items-center">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search..."
                className="w-64 bg-zinc-900/50 border border-white/5 text-xs text-zinc-300 rounded-full pl-9 pr-4 py-2 focus:outline-none focus:ring-1 focus:ring-white/20 focus:border-white/20 transition-all placeholder:text-zinc-600"
              />
            </div>
          </div>
          ...
          <div className="relative">
            <button
              ...
              className="relative text-zinc-500 hover:text-white transition-colors p-2 rounded-md hover:bg-white/5"
            >
              ...
              <>
                ...
                <div className="absolute right-0 mt-2 w-80 bg-zinc-900 border border-white/10 rounded-lg shadow-xl shadow-black/50 z-50 overflow-hidden">
                  ...
                  <div className="max-h-80 overflow-y-auto">
                    {notifications.map((notification) => (
                      <div
                        key={notification.id}
                        className={cn(
                          "p-3 hover:bg-white/5 cursor-pointer transition-colors border-b border-white/5 last:border-0",
                  ...
                  <div className="p-2 border-t border-white/5">
                    <button className="w-full text-center text-xs text-zinc-500 hover:text-zinc-300 py-2 transition-colors">
