...
export default function SettingsProfile() {
  const [profile, setProfile] = useState({ ...PROFILE_DEMO });
  ...
  return (
    <Card className="bg-zinc-900/80 border border-zinc-700 shadow-lg rounded-xl">
      <CardContent className="py-10 px-6 md:px-10 flex flex-col gap-8">
        <div className="flex flex-row gap-8 items-start">
          <div className="flex flex-col items-center gap-2">
            <div className="w-24 h-24 rounded-full overflow-hidden bg-gradient-to-tr from-zinc-700 to-zinc-900 border-2 border-zinc-700 flex items-center justify-center">
              {profile.avatarUrl ? (
